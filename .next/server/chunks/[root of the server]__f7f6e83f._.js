...
async function GET(_, { params }) {
    ...
    const slug = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].string().parse(params.slug);
    const product = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$products$2f$data$2e$json__$28$json$29$__["default"].products.find((product)=>product.slug === slug);
    if (!product) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__f7f6e83f._.js.map